...
class SongAdapter(var lstSong: List<SongModel>): RecyclerView.Adapter<SongAdapter.ViewHolder>() {
    ...
    class ViewHolder(itemView: View): RecyclerView.ViewHolder(itemView){
        ...
        val tvCountView: TextView = itemView.findViewById(R.id.tvCountViews)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.tvCountView.text = itemSong.countViews
